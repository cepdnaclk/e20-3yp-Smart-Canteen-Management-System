...
class _MerchantSignupScreenState extends State<MerchantSignupScreen> {
  ...
  Future<void> registerMerchant() async {
    ...
    try {
      final url = Uri.parse('http://192.168.56.1:8081/api/auth/register/merchant');
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  style: const TextStyle(color: Colors.black),
                  validator: (value) =>
                  value == null || value.isEmpty ? 'Enter Canteen name' : null,
                ),
                const SizedBox(height: 16),
                ...
                AnimatedActionButton(
                  ...
                  onTap: _isLoading ? null : () => registerMerchant(),
                  isOutlined: false,
                ),
