...
class _BudgetDashboardState extends State<BudgetDashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    double spendProgress =
        plannedBudget == 0 ? 0 : totalExpense / plannedBudget;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 10),
          Text(
            "Rs: ${leftToSpend.toStringAsFixed(2)}",
            style: TextStyle(
              fontSize: 32,
              color: Colors.white,
  ...
  Widget _buildProgressBar(double leftToSpend, double progress) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 5),
        Text(
          "Rs: ${leftToSpend.toStringAsFixed(2)} out of Rs: ${plannedBudget.toStringAsFixed(2)}",
        ),
        SizedBox(height: 10),
