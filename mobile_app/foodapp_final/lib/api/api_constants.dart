...
class ApiConstants {
  static const String baseUrl = 'http://192.168.237.203:8081'; // Use your actual IP
  ...
  static const String merchantMenuImage = '/api/merchant/menu/';
  static const String merchantReportsDaily = '/api/merchant/reports/sales/daily';
  static const String merchantSalesReport = '/api/merchant/reports/sales';
  ...
  static const String adminGetAllUsers = '/api/admin/users'; // <-- ADDED: Fetches all users (Customers and Merchants)
  static const String adminDashboardSalesChart = '/api/admin/dashboard/sales-chart'; // <-- ADDED: For dashboard chart
  static const String canteenCongestion = '/api/canteen/congestion';
