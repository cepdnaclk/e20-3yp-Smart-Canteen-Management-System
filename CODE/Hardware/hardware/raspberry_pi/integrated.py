...
# --- Flask Endpoints (from purple_bio.py) ---
...
# --- RFID Reader Thread (from purple_bio.py) ---
...
class LauncherGUI:
    def __init__(self, root):
        ...
        # Center window
        self.root.eval('tk::PlaceWindow . center')# Style configuration
        style = ttk.Style()
    ...
    def show_launcher(self):
        ...
        welcome_label = tk.Label(self.current_frame, text="??? Welcome to Smart Canteen", fg=PRIMARY_ACCENT, bg=BACKGROUND_COLOR,
...
# --- Registration GUI (from purple_bio.py) ---
