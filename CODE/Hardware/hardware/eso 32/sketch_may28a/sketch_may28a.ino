...
// Use UART1 with explicit pin assignment (RX=16, TX=17)
HardwareSerial mySerial(1); // CHANGED: UART2 → UART1
...
void setup() {
  ...
  // Initialize UART1 with pins 16 (RX), 17 (TX) and serial mode
  mySerial.begin(57600, SERIAL_8N1, 16, 17); // ADDED: Pin configuration
  finger.begin(57600);

  delay(1000); // ADDED: Allow sensor initialization time
