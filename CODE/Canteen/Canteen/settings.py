...
SECRET_KEY = "django-insecure-*1v-)a2j9kyy!rte5=mfe-=bd^22!*u7%=*fzr^e5q**1swq&_"
...
TEMPLATES = [
    {
        ...
        "DIRS": ['templates/home','templates/customer','templates/merchant'],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
# Path to the directory where static files will be collected when you run `collectstatic`
