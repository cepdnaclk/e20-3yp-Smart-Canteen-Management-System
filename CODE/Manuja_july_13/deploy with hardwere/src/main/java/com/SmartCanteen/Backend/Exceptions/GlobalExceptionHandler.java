...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(FingerprintNotRegisteredException.class)
    public ResponseEntity<String> handleFingerprintNotRegistered(FingerprintNotRegisteredException ex) {
