...
public class CustomerController {
    ...
    //manuja
    @GetMapping("/profile/rfid/{cardid}")
    public ResponseEntity<CustomerResponseDTO> getProfileByRfid(@PathVariable String cardid) {
        CustomerResponseDTO customer = customerService.getProfileById(cardid);
        return ResponseEntity.ok(customer);
    }
    @GetMapping("/fingerprint")
    public ResponseEntity<FingerprintResponseDto> getFingerprintByEmail(@RequestParam String email) {
        FingerprintResponseDto dto = customerService.getFingerprintByEmail(email);
